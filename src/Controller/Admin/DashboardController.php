...
//        return parent::index();
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Currency Pair', 'fas fa-list', CurrencyPair::class);
        yield MenuItem::linkToCrud('Offers', 'fas fa-list', Offer::class);
        yield MenuItem::linkToCrud('Wallet Transaction', 'fas fa-list', WalletTransaction::class);
    }
}
